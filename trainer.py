...
class Trainer(object):
    ...
    def test(self, dataloader="test"):
        ...
        if dataloader == "test":
            ...
            self._plot_threshold_curves(y_label, y_pred, thresholds, fpr, tpr, prec, recall)
    ...
    def _plot_threshold_curves(self, y_label, y_pred, thresholds, fpr, tpr, prec, recall):
        """
