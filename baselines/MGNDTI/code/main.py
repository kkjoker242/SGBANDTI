...
parser.add_argument('--split', type=str, metavar='SPLIT', help='data split (e.g., random, cluster)', default='random')
parser.add_argument('--seeds', type=str, metavar='SEEDS', help='comma-separated seeds, e.g. 82 or 42,52,62,72,82', default=None)
...
def main():
    ...
    for seed in seeds:
        ...
        output_path = os.path.join(cfg.RESULT.OUTPUT_DIR, args.data, args.split, f"seed_{seed}")
